...
class GeneratorTest(unittest.TestCase):
    ...
    def test_bal_patch_2D(self):
        """
        Tests shapes for 2D balanced patch generation from the PosRandomPatchGenerator.
        * Does not test the distribution, which is done through an eye test
        """
        # instantiating generators
        mode = "bal"
    ...
    def test_bal_patch_3D(self):
        """
        Tests shapes for 3D balanced patch generation from the PosRandomPatchGenerator.
        * Does not test the distribution, which is done through an eye test
        """
        mode = "bal"
    ...
    def test_data_aug_rand_2D(self):
        """
        Tests shape for data augmentation for randomly generated 2D patches.
        * Actual data aug tests are done by Isensee in the batchgenerators library.
        """
        # instantiating generators
        mode = "rand"
        rand_gen_2D = PosRandomPatchGenerator(self.list_IDs, self.data_dirs, self.batch_size, self.patch_shape_2D,
    ...
    def test_data_aug_rand_3D(self):
        """
        Tests shape for data augmentation for randomly generated 3D patches.
        * Actual data aug tests are done by Isensee in the batchgenerators library.
        """
        # instantiating generators
        mode = "rand"
